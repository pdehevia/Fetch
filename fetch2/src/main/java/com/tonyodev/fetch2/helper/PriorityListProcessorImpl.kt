...
class PriorityListProcessorImpl constructor(private val handlerWrapper: HandlerWrapper,
    ...
    init {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            context.registerReceiver(priorityBackoffResetReceiver, IntentFilter(ACTION_QUEUE_BACKOFF_RESET), if (Build.VERSION.SDK_INT > Build.VERSION_CODES.TIRAMISU) RECEIVER_NOT_EXPORTED else 0)
        } else {
